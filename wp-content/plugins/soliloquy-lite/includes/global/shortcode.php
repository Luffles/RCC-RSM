...
class Soliloquy_Shortcode_Lite {
    ...
    public function get_image_slide( $id, $item, $data, $i ) {
        ...
        if ( ! empty( $item['caption'] ) ) {
            ...
            $output .= '<div class="soliloquy-caption"><div class="soliloquy-caption-inside"><div class="captionTop">';
                $caption = apply_filters( 'soliloquy_output_caption', $item['caption'], $id, $item, $data, $i );
                $output .= $caption;
                $output .= '</div>';
                  if ( ! empty( $item['caption_bottom'] ) ) {
                    $output .= '<div class="captionBottom">';
                    $caption_bottom = apply_filters( 'soliloquy_output_caption', $item['caption_bottom'], $id, $item, $data, $i );
                    $output .= $caption_bottom;
                    $output .= '</div><a class="readMore" href="' . esc_url( $item['link'] ) . '"></a></div></div>';
